    ...
    <el-card class="box-card">
      ...
      <el-dialog title="编辑用户" :visible.sync="editDialogVisible" width="40%">
        ...
        <el-form
          ...
          label-width="70px"
        >
          <el-form-item label="用户名" props="username2">
            <el-input size="small" disabled v-model="editForm.username"></el-input>
          </el-form-item>
          <el-form-item label="邮箱" required props="email2">
            <el-input v-model="editForm.email"></el-input>
          </el-form-item>
          <el-form-item label="手机" required props="mobile2">
...
export default {
  data() {
    return {
      ...
      editForm: {},
      editFormRules: {
        // 可以直接沿用之前定义的添加用户表单验证的规则
        email2: [{ validator: checkEmail, trigger: "blur" }],
        mobile2: [{ validator: checkMobile, trigger: "blur" }],
      },
    };
  },
  created() {
