  ...
  <div class="params">
    ...
    <el-dialog :visible.sync="addDialogVisible">
      <el-form ref="addParamsFormRef" :model="addParamsForm" :rules="addParamsFormRules">
        <el-form-item label="添加参数" prop="attr_name" label-width="100px">
          <el-input v-model="addParamsForm.attr_name"></el-input>
        </el-form-item>
      </el-form>
      <div slot="footer">
        <el-button @click="addDialogVisible = false">取 消</el-button>
        <el-button type="primary" @click="submitForm('addParamsForm')">确 定</el-button>
      </div>
    </el-dialog>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    async submitForm(addParamsForm) {
      // 表单提交验证
      this.$refs.addParamsFormRef.validate((valid) => {
        ...
        if (valid) {
          const {data:res} = await this.$http.put(`categories/${this.getCateId}/attributes`,{
