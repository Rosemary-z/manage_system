    ...
    <el-card>
      ...
      <el-row class="cat_opt">
        ...
        <el-tab-pane label="动态参数" name="many">
          <AttributesTab :activeName="activeName" :attr_id="attr_id" ref="attributeTab" />
        </el-tab-pane>
...
export default {
  ...
  methods: {
    ...
    handleChange() {
      ...
      console.log("状态机中attr_id的数据", this.$store.state.getAttr_Id.attr_id);
      // 调用子组件的方法函数渲染最新的参数列表
